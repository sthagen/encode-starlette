...
class BaseHTTPRequestHandler:
    ...
    async def parse_request(self):
        ...
        try:
            self.headers = await self.parse_headers(_class=self.MessageClass)
        ...
        if (expect.lower() == "100-continue" and
            ...
            if not await self.handle_expect_100():
                return False
        return True

    async def parse_headers(self, _class):
...
async def handle_echo(reader, writer):
    handler = BaseHTTPRequestHandler(reader, writer)
